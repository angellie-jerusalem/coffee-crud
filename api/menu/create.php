...
if (
    ...
    if ($item->create()) {
        ...
        echo json_encode(["success" => false, "message" => "Unable to create item."]);
    }
} else {
    http_response_code(400);
    echo json_encode(["success" => false, "message" => "Incomplete data. Name, category, and price are required."]);
}
?>
